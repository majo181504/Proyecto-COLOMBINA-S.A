...
-- Al inicio del script, en orden inverso de dependencias
DROP TABLE IF EXISTS "accionista" CASCADE;
DROP TABLE IF EXISTS "proveedor_materia" CASCADE;
...
DROP TABLE IF EXISTS "area_departamento" CASCADE;
...
--cambio en el constraint, lo deje de ultimo y puse fecha_pago y fecha_vencimiento primero
...
--deje el constraint al final tambien en tipo_contrato
...
--cambio en id_proveedor_materia, para no inventar ids, sino que postgres automaticamente lo hace SIEMPRE
CREATE TABLE "proveedor_materia" (
  "id_proveedor_materia" integer GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
  "id_proveedor" integer NOT NULL,
